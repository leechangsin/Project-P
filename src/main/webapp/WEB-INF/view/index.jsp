	...
	<div id="container">
		...
		<div id="sideinfo">
			...
			<div class="categorybox">
				...
				<div class="dynamic_area">
					...
					<a href="">(symbol) 발전 가능성이 많아</a><br>
					<a href="">(symbol) 반려동물은</a><br>
					<a href="">(symbol) 내가 키우면 반려동물</a><br>
					<a href="">(symbol) 종류의 제한은 없지</a><br>
					<a href="">(symbol) 이 사이트는</a><br>
					<a href="">(symbol) 반려동물의 사진</a><br>
					<a href="">(symbol) 동영상,용품까지 </a><br>
					<a href="">(symbol) 모두 등록이 가능하지</a><br>
		...
		<div id="contents">
			...
			<div class="list-group">
				<div class="list-group-item active">실시간 인기best5</div>
				<!--  
				<div class="progress">
